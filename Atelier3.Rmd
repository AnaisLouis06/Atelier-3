...
Consommation de chocolat chez les hommes et les femmes
...
```{r}
pie(table(chocol.h),main = "Consommmation chez les hommes")
...
La distibution de la variable poids
